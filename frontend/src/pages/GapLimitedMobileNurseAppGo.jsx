...
// v0 scaffold for: Limited mobile nurse app for on-the-go updates
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-limited-mobile-nurse-app-go/run.

export default function LimitedMobileNurseAppGoPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-mobile-nurse-app-go/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Limited mobile nurse app for on-the-go updates</h1>
