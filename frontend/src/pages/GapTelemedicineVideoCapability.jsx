...
// v0 scaffold for: No telemedicine video capability
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-telemedicine-video-capability/run.

export default function TelemedicineVideoCapabilityPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-telemedicine-video-capability/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No telemedicine video capability</h1>
