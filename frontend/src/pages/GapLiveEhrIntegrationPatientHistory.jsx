...
// v0 scaffold for: No live EHR integration (patient history, med reconciliation)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-live-ehr-integration-patient-history/run.

export default function LiveEhrIntegrationPatientHistoryPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-live-ehr-integration-patient-history/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No live EHR integration (patient history, med reconciliation)</h1>
