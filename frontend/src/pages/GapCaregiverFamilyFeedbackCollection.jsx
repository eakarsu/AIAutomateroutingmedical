...
// v0 scaffold for: No caregiver / family feedback collection
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-caregiver-family-feedback-collection/run.

export default function CaregiverFamilyFeedbackCollectionPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-caregiver-family-feedback-collection/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No caregiver / family feedback collection</h1>
